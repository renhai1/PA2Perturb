...
cross_task_data = {
    "GCN": {
        "Node → Edge":  [93.2, 92.4, 93.7, 91.8, 90.5, 89.6],
        "Node → Graph": [89.7, 89.1, 88.3, 87.5, 86.4, 85.8],
        "Edge → Node":  [92.1, 91.5, 92.8, 90.6, 89.8, 88.9],
        "Edge → Graph": [88.4, 87.6, 87.1, 86.3, 85.5, 84.7],
        "Graph → Node": [87.6, 86.8, 86.2, 85.4, 84.1, 83.5],
        "Graph → Edge": [87.1, 86.3, 85.7, 84.9, 83.6, 82.9],
    },
    "GraphSAGE": {
        "Node → Edge":  [92.4, 91.7, 93.1, 91.2, 89.8, 89.1],
        "Node → Graph": [88.9, 88.2, 87.5, 86.3, 85.6, 84.9],
        "Edge → Node":  [91.5, 90.8, 92.0, 89.7, 89.1, 88.2],
        "Edge → Graph": [87.6, 86.9, 86.2, 85.4, 84.5, 83.8],
        "Graph → Node": [86.8, 86.1, 85.5, 84.6, 83.4, 82.7],
        "Graph → Edge": [86.2, 85.5, 84.9, 84.1, 82.8, 82.1],
    },
    "GAT": {
        "Node → Edge":  [95.8, 95.3, 94.7, 95.1, 93.4, 92.8],
        "Node → Graph": [92.6, 92.1, 91.5, 90.8, 89.7, 89.1],
        "Edge → Node":  [95.1, 94.7, 93.9, 94.3, 92.5, 91.9],
        "Edge → Graph": [91.8, 91.2, 90.6, 89.9, 88.8, 88.2],
        "Graph → Node": [91.1, 90.4, 89.8, 89.2, 88.1, 87.4],
        "Graph → Edge": [90.5, 89.8, 89.2, 88.6, 87.3, 86.7],
    },
    "GIN": {
        "Node → Edge":  [90.6, 89.8, 90.2, 88.7, 87.4, 86.8],
        "Node → Graph": [87.3, 86.5, 85.9, 85.1, 84.2, 83.5],
        "Edge → Node":  [89.4, 88.7, 89.1, 87.5, 86.6, 85.9],
        "Edge → Graph": [86.1, 85.4, 84.8, 84.1, 83.2, 82.4],
        "Graph → Node": [85.3, 84.6, 84.1, 83.4, 82.3, 81.6],
        "Graph → Edge": [84.7, 84.0, 83.5, 82.8, 81.7, 81.0],
    },
}

# ========== 科研论文配色 (Nature-style, 高区分度) ==========
task_pair_styles = {
    "Node → Edge":  {"color": "#2166AC", "marker": "o",  "ls": "-"},    # 深蓝
    "Node → Graph": {"color": "#E08214", "marker": "s",  "ls": "-"},    # 橙
    "Edge → Node":  {"color": "#1B7837", "marker": "D",  "ls": "--"},   # 深绿
    "Edge → Graph": {"color": "#B2182B", "marker": "^",  "ls": "--"},   # 深红
    "Graph → Node": {"color": "#762A83", "marker": "v",  "ls": ":"},    # 紫
    "Graph → Edge": {"color": "#8C510A", "marker": "P",  "ls": ":"},    # 棕
}
